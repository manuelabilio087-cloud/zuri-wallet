...
export default function ForgotPasswordPage() {
  ...
  async function onSubmit(data: ForgotPasswordForm) {
    ...
    try {
      ...
      // Mostramos sempre sucesso, exista ou não a conta — não revelamos isso.
      setSent(true);
    } catch (err) {
    ...
    <div className="flex min-h-screen items-center justify-center bg-ocean-950 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="font-display text-2xl font-medium text-sand-100">Recuperar senha</h1>
          <p className="mt-1 text-sm text-sand-400">
            Indica o teu e-mail e enviamos um link para repores a senha
          </p>
        </div>
